...
#'@param year Year
#'@param lecturer character vector with names of lecturers
#'
#'@return a special class, monash unit with the unit information as a list
#'
#'@examples
#'unit_info(unit = "ETC5521", name = "Exploratory Data Analysis",semester=1,year=2020,
#'lecturer = c("Emi Tanaka" = "emi.tanaka@monash.edu",  "Di Cook" = "dicook@monash.edu"))
#'
#' @export
unit_info <- function(unit, name, semester,year, lecturer){
   unitinfo <- list(unit = paste0(unit," S",semester,year), name = as.character(name), lecturer=lecturer)
